      ...
      <div className="grid grid-cols-3">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">{song.album.artists[0].name}</p>
          </div>
        </div>
        <div className="flex items-center justify-center">
          <FontAwesomeIcon
            ...
            className={`text-white text-3xl mx-2 h-[40px] w-[40px] ${song.preview_url != null ? 'cursor-pointer' : 'opacity-50 pointer-events-none'}`}
          />
        </div>
      </div>
    </footer>
